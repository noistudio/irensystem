...
class CrudBlogCategorysAddFieldBackground extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $json_data = '{"background":{"unique":0,"showsearch":0,"order":1,"required":0,"showinlist":0,"title":"\u0411\u0435\u0433\u0440\u0430\u0443\u043d\u0434 \u0444\u043e\u043d\u043e\u0432\u044b\u0439","type":"Elfinder","options":{"isimage":true,"type":"none","width":null,"height":null}}}';

        $table_data = json_decode($json_data, true);
            
        $newtable  = \db\JsonQuery::get('blog_categorys', "tables", "name");
    ...
    public function down()
    {
         ...
         $table = \content\models\TableConfig::get('blog_categorys');
         $json_data = '{"background":{"unique":0,"showsearch":0,"order":1,"required":0,"showinlist":0,"title":"\u0411\u0435\u0433\u0440\u0430\u0443\u043d\u0434 \u0444\u043e\u043d\u043e\u0432\u044b\u0439","type":"Elfinder","options":{"isimage":true,"type":"none","width":null,"height":null}}}';
         $table_data = json_decode($json_data, true);
         foreach($table_data as $name_field=>$new_field){
