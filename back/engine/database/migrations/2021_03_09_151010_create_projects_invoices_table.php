...
class CreateProjectsInvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        TableConfig::delete(config("database.table_prefix") . "project_invoices");
    }
}
