...
//});
	...
	if ($("#editorjs").length > 0) {
		...
		var const_editor_options = {
			...
			tools: {
				...
				linkTool: {
					class: LinkTool,
					config: {
						endpoint: url_fetchUrl, // Your backend endpoint for url data fetching
					}
				},
				Marker: {
					class: Marker,
				...
				image: {
					...
					config: {
						...
						endpoints: {
							byFile: url_uploadImage, // Your backend file uploader endpoint
		...
		if (editorjs_value_one) {

			const_editor_options['data'] = {};
			const_editor_options['data'] = editorjs_value_one;
		} else {
			const_editor_options['data'] = {};
			const_editor_options['data']['blocks'] = editorjs_value;
		}
