...
<div class="block">
    ...
    <h4 style="display:none;"><?php echo __("backend/content.setup_select") ?></h4>
    <?php
    ?>
            ...
            foreach ($rows as $row) {
                ...
                <div class="block ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-1">
                            <!--                            <a href="{pathadmin}content/manage/enable/-->
                            <?php //echo $table->name; ?><!--/--><?php //echo $row['last_id']; ?><!--">-->
                            <!--                                --><?php
                            //                                if ((int) $row['enable'] == 1) {
                            //                                    ?>
                            <!--                                    <i class="fa fa-eye"></i>-->
                        ...
                        <!---->
                        <!---->
                        <!--                                    <a href="{pathadmin}content/arrows/up/-->
                        <?php //echo $table->name; ?><!--/--><?php //echo $row["last_id"]; ?><!--?-->
                        <?php //echo $get_vars_string; ?><!--"><i class="fa fa-arrow-up" aria-hidden="true"></i></a>-->
                        <!---->
                        <!--                                    <p><input type="number" class="form-control position" value="-->
                        <?php //echo $row['sort']; ?><!--"><button type="button" data-link="{pathadmin}content/arrows/move/-->
                        <?php //echo $table->name; ?><!--/-->
                        <?php //echo $row["last_id"]; ?><!--/" class="movebtn btn btn-danger">-->
                        <?php //echo __("backend/content.move") ?><!--</button></p>-->
                        <!--                                    <a href="{pathadmin}content/arrows/down/-->
                        <?php //echo $table->name; ?><!--/--><?php //echo $row["last_id"]; ?><!--?-->
                        <?php //echo $get_vars_string; ?><!--"><i class="fa fa-arrow-down" aria-hidden="true"></i></a>-->
                        <!--                                    --><?php
                        //                                } else {
                        //                                    ?>
                        <!--                                    <a href="{pathadmin}content/arrows/down/-->
                        ...
                        <div class="col-xs-offset-1 col-xs-4 ">
                            <a class="btn btn-primary"
                               href="{pathadmin}content/manage/update/<?= $table->name; ?>/<?= $row['last_id']; ?>"><i
                                        class="fa fa-pencil-square-o"></i>Просмотр
                            </a>
                        </div>
