...
<head>
    ...
    <!-- END Icons -->
    <script>
		var url_fetchUrl = "<?php echo route("back.editorjs.fetchUrl"); ?>";
		var url_uploadImage = "<?php echo route("back.editorjs.uploadImage"); ?>";
		var url_uploadFile = "<?php echo route("back.editorjs.uploadFile"); ?>";
    </script>
    <!-- Stylesheets -->
...
?>
<body id="pathadmin" data-link-fetchurl="<?php echo route('backend/editjs/link/fetch'); ?>"
      data-file-upload="<?php echo route('backend/editjs/image/upload'); ?>" data-path="{pathadmin}"
      data-elfinder-connector="<?= route("elfinder.connector") ?>">
<!-- Page Wrapper -->
            ...
            <div id="sidebar-scroll">
                ...
                <div class="sidebar-content">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        ?>">
                            <a href="<?php echo route('backend/index'); ?>"><i
                                        class="gi gi-compass sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide"><?php echo __("backend/main.home"); ?></span></a>
                        </li>
                            ...
                            foreach ($links_global as $link) {
                                ...
                                if ($haveaccess) {
                                    if (count($link['sub']) == 0) {
                                        ...
                                        if (isset($query_string) and strlen(
                                                $query_string
                                            ) > 1 and $link['href'] == $query_string) {
                                            $main_class = "active";
                                        }
                                        ?>
                                        <li class="<?php
                                        echo $main_class;
                                        ?>">
                                            <a href="<?php echo route('backend', array(), false)."/".$link['href']; ?>"><i
                                                        class="fa <?php echo $link['icon']; ?> sidebar-nav-icon"></i><span
                                                        class="sidebar-nav-mini-hide"><?php echo $link['title']; ?></span></a>
                                        </li>
                                        <?php
                                    } else {
                                        $main_class = "";
                                        ...
                                        foreach ($link['sub'] as $sub_link) {
                                            ...
                                            if ($haveaccess) {
                                                $subclass = "";
                                                if (isset($sub_link['nav']) and strlen(
                                                        $sub_link['nav']
                                                    ) > 1 and $subnav == $sub_link['nav']) {
                                                    $subclass = "active";
                                                    $main_class = "active";
                                                }
                                                ...
                                                if (isset($query_string) and strlen(
                                                        $query_string
                                                    ) > 1 and $sub_link['href'] == $query_string) {
                                                    $subclass = "active";
                                                    $main_class = "active";
                                                }
                        ...
                        <li>
                            <a href="<?php echo route('backend/logout', array(), false); ?>"><i
                                        class="fa fa fa-sign-out sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide"><?php echo __(
                                        "backend/main.logout"
                                    ); ?></span></a>
                        </li>
                    ...
                    <ul class="nav navbar-nav-custom  hidden-sm hidden-lg hidden-md hidden-print ">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                               aria-haspopup="true" aria-expanded="false"><i class="fa fa-cogs"></i> <span
                                        class="caret"></span></a>
                        ...
                        foreach ($languages as $lang) {
                            ...
                            <li>
                                <a href="<?php echo route("backend/setlanguage", array('locale' => $lang)); ?>">
                                    <img src="/themebackend/img/lang_<?php echo $lang; ?>.png"
